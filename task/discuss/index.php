				...
				<div class="wrapper">
					<div>
						<div class="_co_box_framework0">
							...
							<div class="image">
								<div style="padding: 10px;"><img id="task_poster"></div>
							</div>										
								<div class="_co_box_qu_content1">
									<div style="padding: 5px;">
									<p id="task_name"class="user_name">姓名:索隆</p>
									<p id="task_department">學校:海賊王大學</p>
									<p id="task_skill">專長:
							...
							<div class="_co_box_qu_framework1_2">								
								...
								<p style="margin: 10px;">最近25了在打拉鋸，發現打人都不痛，才知道他們都有把裝備升等...
