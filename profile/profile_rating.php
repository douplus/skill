	<ul id="cv_list" _tabbed="#cv_tabs-1">
		...
		<li class="tabs-active"><a class="cv_list_a" href="./index.php?stream=rating&u=<?php echo $u;?>&v=<?php echo $v;?>" data-pjax="stream-rating"><div class="chinese">評分</div></a></li>
